...
public class CSVParserConstants {
	...
	static {
		...
		temp.put("System", Arrays.asList(INTTYPE, STRINGTYPE, STRINGTYPE, DATETYPE, DATETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE));
	...
	static
	{
		...
		temp3.put("System", Arrays.asList("serialNumberInserv", "system_companyName", "system_model", "updated", "system_install_date", "capacity_total_sizeTiB", "capacity_total_freePct", "capacity_byType_fc_sizeTiB", "capacity_byType_nl_sizeTiB", "capacity_byType_ssd_sizeTiB", "virtualCapacity_byType_tdvv_vvCount", "virtualCapacity_byType_tdvv_sizeTiB", "capacity_total_dedupeRatio"));
