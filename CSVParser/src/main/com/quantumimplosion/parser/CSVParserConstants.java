...
public class CSVParserConstants {
	...
	static {
		...
		temp.put("Node Information", Arrays.asList(INTTYPE, DATETYPE, DATETYPE, STRINGTYPE, DOUBLETYPE, DOUBLETYPE));
		temp.put("System", Arrays.asList(INTTYPE, DATETYPE, DATETYPE, STRINGTYPE, STRINGTYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE, DOUBLETYPE));
